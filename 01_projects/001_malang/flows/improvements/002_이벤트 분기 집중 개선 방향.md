...
- 상세: [[01_projects/001_malang/flows/improvements/004_리얼타임 목적-응답-아이템 맵 정리 개선안|리얼타임 목적-응답-아이템 맵 정리 개선안]]
...
## 연결 노트
- 함수 맵: [[01_projects/001_malang/flows/005_프론트 시나리오 테스트 함수 맵 v2|프론트 시나리오 테스트 함수 맵(v2)]]
- 개선 인덱스: [[01_projects/001_malang/flows/improvements/000_개선 방향 인덱스|개선 방향 인덱스]]
- 실행 체크: [[01_projects/001_malang/flows/improvements/006_개선 실행 체크리스트|개선 실행 체크리스트]]
